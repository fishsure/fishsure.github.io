...
const translations = {
  en: {
    ...
    'publications-summary': 'My research focuses on LLM Memory, AI Agents, and RAG systems. I have published papers on hierarchical memory mechanisms for personalized generation (WWW 2026), deep research agents for commercial report synthesis, and knowledge pruning for retrieval-augmented generation (CIKM 2025).',
    'projects-selected': 'Selected Projects and Competitions',
    'projects-summary': 'I have contributed to several impactful open-source projects and competitions, including winning a Silver Medal in Meta KDD Cup 2024 CRAG Benchmark, developing Agent-R1 (1.3k+ stars) for training LLM agents with reinforcement learning, and building Science-Star (700+ stars) for scientific agent platforms.',
    'show-all': 'Show All',
  ...
  zh: {
    ...
    'publications-summary': '我的研究聚焦于大语言模型记忆、AI智能体和RAG系统。我在个性化生成的层次化记忆机制（WWW 2026）、商业报告合成的深度研究智能体、以及检索增强生成的知识剪枝（CIKM 2025）等方面发表了论文。',
    'projects-selected': '代表性项目与竞赛',
    'projects-summary': '我参与并贡献了多个有影响力的开源项目和竞赛，包括获得Meta KDD Cup 2024 CRAG比赛银牌，开发了用于强化学习训练LLM智能体的Agent-R1（1.3k+ stars），以及构建了科学智能体平台Science-Star（700+ stars）。',
    'show-all': '显示全部',
    'show-selected': '显示代表性',
